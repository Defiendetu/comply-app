...
const SECTORES: Record<string, any> = {
  inmobiliario: {
    ...
    senales_clientes: [
      'Clientes que buscan adquirir inmuebles por valores significativamente superiores al avalúo comercial sin justificación (Ref: GAFI - Indicadores de riesgo sector inmobiliario).',
      'Clientes que insisten en realizar pagos en efectivo o solicitan que la operación se efectúe con dinero en efectivo y/o activos virtuales sin transparencia en cuanto a la fuente del pago (Ref: GAFI/UIAF).',
      ...
      'Clientes que solicitan que la escrituración se realice a nombre de terceros sin relación aparente o mediante estructuras de titularidad complejas para ocultar al beneficiario final (Ref: GAFI - Tipologías inmobiliarias).',
      'Arrendatarios que ofrecen pagar varios meses o años de arriendo por anticipado sin justificación económica.',
      'Personas que compran múltiples propiedades en cortos periodos de tiempo sin fuente de ingresos visible o cuyo perfil financiero no justifica las adquisiciones.',
      'Clientes que solicitan que el valor en la escritura sea diferente al valor real de la transacción (subfacturación o sobrefacturación deliberada).',
      'Compradores extranjeros que no pueden demostrar el origen lícito de los fondos o que tienen vínculos con jurisdicciones de alto riesgo según listas del GAFI.',
      'Incremento injustificado en las cuentas bancarias de personas naturales y/o jurídicas cuya actividad económica se relacione con agentes inmobiliarios (Ref: UIAF).',
      'Personas jurídicas del sector que escinden parcialmente su patrimonio para crear nuevas sociedades mercantiles sin justificación comercial (Ref: Infolaft/GAFI).',
      'Socios o miembros de juntas directivas de la contraparte que aparecen con registros en alguna lista restrictiva o vinculante (Ref: Circular Básica Jurídica).',
      'Desistimiento de fiducias inmobiliarias en las cuales los recursos del adquirente ingresan al proyecto y posteriormente son retirados sin justificación (Ref: UIAF - Tipologías fiduciarias).',
    ],
    senales_proveedores: [
      'Avaluadores que emiten avalúos significativamente por encima o por debajo del valor de mercado sin justificación técnica.',
      'Intermediarios o tramitadores informales que no están debidamente registrados y ofrecen facilitar transacciones sin los controles regulatorios (Ref: Evaluación Nacional de Riesgos - subsector finca raíz).',
      ...
      'Notarios o abogados que facilitan transacciones sin verificar el origen de los fondos.',
    ],
  ...
  juridico: {
    ...
    senales_clientes: [
      'Clientes que solicitan la constitución de múltiples sociedades sin un propósito comercial claro o con coincidencia de representantes legales, socios y direcciones (Ref: GAFILAT - Tipologías 2025, uso de personas jurídicas).',
      'Clientes que solicitan servicios de representación legal y ofrecen honorarios desproporcionados al servicio prestado.',
      'Personas que buscan asesoría para estructurar operaciones que eviten umbrales de reporte o controles regulatorios.',
      'Clientes que muestran interés excesivo en la confidencialidad más allá del secreto profesional normal, particularmente en operaciones de compraventa de bienes, constitución de sociedades o administración de activos (Ref: GAFI Rec. 22).',
      'Personas que solicitan la creación de estructuras jurídicas complejas (fiducias, holdings, sociedades en cascada) sin justificación comercial razonable (Ref: GAFI - Professional Money Laundering).',
      'Clientes que pagan honorarios desde cuentas en jurisdicciones de alto riesgo según listas del GAFI o a través de terceros no relacionados.',
      'Personas que solicitan actuar como testaferros o interpuestas personas en la titularidad de bienes o sociedades.',
      'Clientes con antecedentes penales relacionados con delitos fuente de LA/FT que buscan reestructurar sus activos o constituir nuevas sociedades.',
      'Clientes que solicitan asesoría para la compraventa de bienes inmuebles, constitución o gestión de personas jurídicas, o administración de activos de terceros sin debida justificación (Ref: GAFI Rec. 22 - operaciones específicas para APNFD del sector jurídico).',
      'Personas jurídicas clientes que presentan coincidencia de representantes legales, socios o direcciones con otras sociedades vinculadas a investigaciones judiciales (Ref: GAFILAT 2025).',
    ],
    senales_proveedores: [
      'Firmas de abogados que ofrecen constitución de sociedades a precios inusualmente bajos o sin verificar la identidad del beneficiario final.',
      'Asesores legales que ofrecen estructurar operaciones para evadir controles antilavado o umbrales de reporte.',
      'Notarías con volumen inusual de operaciones con determinados clientes o que no realizan debida diligencia.',
      'Corresponsales judiciales que gestionan cobros o pagos sin la debida trazabilidad del origen de los fondos.',
    ],
    controles_especificos: [
  ...
  contable: {
    ...
    senales_clientes: [
      'Clientes que solicitan registrar transacciones sin el debido soporte documental o con documentación claramente falsificada.',
      'Empresas con ingresos que no guardan proporción con su capacidad operativa o con el número de empleados declarados (Ref: Evaluación Nacional de Riesgos - sector contable).',
      'Clientes que insisten en utilizar esquemas contables agresivos para reducir artificialmente los ingresos reportados o los activos declarados.',
      'Empresas con número inusual de transacciones con partes relacionadas sin justificación comercial, especialmente con sociedades en jurisdicciones de alto riesgo.',
      'Clientes que solicitan la emisión de facturas por servicios no prestados o por valores que no corresponden a la realidad de la operación.',
      'Empresas que manejan grandes volúmenes de efectivo sin justificación acorde a su actividad económica registrada.',
      'Clientes que cambian frecuentemente de contador o firma contable sin razón aparente, especialmente cuando el cambio coincide con periodos de reporte regulatorio.',
      'Empresas cuyos estados financieros muestran inconsistencias significativas entre periodos o cuya información contable no es conciliable con movimientos bancarios (Ref: Junta Central de Contadores).',
      'Sociedades recién constituidas (menos de 1 año) que presentan volúmenes de operación desproporcionados con su tiempo de existencia (Ref: GAFILAT - Tipología uso de personas jurídicas).',
      'Clientes que solicitan asesoría para la creación de estructuras contables que dificulten la trazabilidad del origen o destino de los fondos.',
    ],
    senales_proveedores: [
      'Proveedores de software contable que no cumplen estándares de seguridad de la información o que permiten la manipulación de registros sin trazabilidad.',
      'Asesores tributarios que promueven esquemas de evasión fiscal o planeación tributaria agresiva sin sustento legal.',
      'Empresas de outsourcing contable constituidas en jurisdicciones de alto riesgo o cuya estructura societaria no es transparente.',
      'Proveedores que emiten certificaciones contables sin realizar los procedimientos de verificación correspondientes.',
    ],
    controles_especificos: [
  ...
  tecnologia: {
    ...
    senales_clientes: [
      'Clientes que contratan servicios de alto valor y pagan desde jurisdicciones de alto riesgo según listas del GAFI o mediante instrumentos financieros poco transparentes.',
      'Contratación de servicios sin especificaciones claras, sin contrato formal, o con requerimientos que cambian constantemente para justificar pagos adicionales.',
      'Clientes que solicitan facturación a nombre de terceros, entidades offshore o sociedades recién constituidas sin operación visible.',
      'Pagos anticipados de alto valor por servicios no definidos formalmente o cuyo alcance no justifica el monto.',
      'Clientes que insisten en utilizar criptomonedas, activos virtuales o medios de pago no convencionales sin transparencia sobre la fuente (Ref: GAFILAT - Tipologías PSAV).',
      'Empresas que contratan servicios tecnológicos (desarrollo, licencias, hosting) sin operación visible que los justifique o cuyo volumen de negocio no corresponde con los servicios contratados.',
      'Clientes que solicitan acceso a datos, infraestructura o servicios sin relación con el objeto del contrato, o que buscan anonimizar sus operaciones digitales.',
      'Contratación de licencias o servicios en cantidades desproporcionadas con el tamaño real del cliente.',
      'Clientes que solicitan desarrollos tecnológicos diseñados específicamente para evadir controles regulatorios o facilitar transacciones no rastreables.',
    ],
    senales_proveedores: [
      'Proveedores de servicios en la nube o infraestructura tecnológica desde jurisdicciones con débiles controles antilavado o sin regulación de protección de datos.',
      'Freelancers o contratistas que no pueden verificar su identidad o ubicación real, o que operan exclusivamente bajo seudónimos.',
      'Empresas de outsourcing tecnológico con estructuras corporativas opacas, múltiples cambios societarios recientes o beneficiarios finales no identificables.',
      'Proveedores que ofrecen servicios a precios significativamente por debajo del mercado sin justificación comercial razonable.',
    ],
    controles_especificos: [
  ...
  comercio: {
    ...
    senales_clientes: [
      'Clientes que realizan compras frecuentes de alto valor y pagan exclusivamente en efectivo, especialmente cuando los montos son levemente inferiores a los umbrales de reporte.',
      'Compradores que devuelven mercancía solicitando reembolso por medio diferente al pago original (efectivo por transferencia o viceversa).',
      'Clientes que compran productos en cantidades que exceden cualquier uso comercial o personal razonable, sin explicación sobre el destino final.',
      'Personas que no muestran interés en calidad, precio o garantía de los productos adquiridos y se enfocan exclusivamente en cerrar la transacción.',
      'Clientes que solicitan facturas a nombre de diferentes razones sociales para las mismas compras o que fragmentan operaciones en múltiples transacciones (Ref: Tipología de fraccionamiento/pitufeo - GAFILAT).',
      'Compradores que pagan con múltiples instrumentos monetarios (cheques, giros, transferencias) a nombre de diferentes personas para una misma operación.',
      'Clientes recurrentes que nunca negocian precios ni solicitan descuentos, comportamiento atípico en transacciones comerciales.',
      'Personas que solicitan envío de mercancía a zonas de frontera, zonas francas o a direcciones que no coinciden con la ubicación declarada del comprador.',
      'Clientes que realizan compras de bienes de alto valor (joyas, electrónica, vehículos) como mecanismo de reserva de valor sin justificación económica acorde a su perfil (Ref: UIAF - Tipologías comercio).',
      'Empresas clientes recién constituidas que presentan volúmenes de compra desproporcionados con su tiempo de operación.',
    ],
    senales_proveedores: [
      'Proveedores que ofrecen mercancía a precios significativamente por debajo del mercado sin justificación comercial (posible contrabando o mercancía de origen ilícito).',
      'Proveedores que no pueden demostrar el origen legal de la mercancía mediante facturación, guías de transporte o certificados de importación.',
      'Empresas proveedoras de reciente constitución que manejan volúmenes de mercancía desproporcionados con su capacidad instalada o su historial comercial.',
      'Proveedores que solicitan pagos a terceros, a cuentas en el exterior o mediante mecanismos que dificultan la trazabilidad del destino de los fondos.',
      'Proveedores que ofrecen condiciones comerciales inusualmente favorables (plazos, descuentos, financiación) sin justificación de mercado.',
    ],
    controles_especificos: [
